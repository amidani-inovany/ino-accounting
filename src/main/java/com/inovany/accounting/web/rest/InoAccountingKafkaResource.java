...
@RestController
@RequestMapping("/api/ino-accounting-kafka")
public class InoAccountingKafkaResource {

    private final Logger log = LoggerFactory.getLogger(InoAccountingKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public InoAccountingKafkaResource(KafkaProperties kafkaProperties) {
